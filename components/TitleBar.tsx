    ...
    <div className="h-8 bg-windows-bg dark:bg-windows-dark-bg flex items-center justify-between select-none border-b border-gray-200 dark:border-windows-dark-border w-full z-50 transition-colors duration-300 titlebar-drag-region">
      ...
      <div className="flex h-full no-drag">
        <div 
          ...
          className="h-full px-4 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-windows-dark-hover cursor-default text-gray-500 dark:text-gray-400 transition-colors" 
          title="Minimize"
        >
          <Minus size={14} />
        </div>
        ...
        <div 
          onClick={handleClose}
          className="h-full px-4 flex items-center justify-center hover:bg-red-500 hover:text-white cursor-default text-gray-500 dark:text-gray-400 transition-colors" 
          title="Close"
        >
          <X size={14} />
        </div>
